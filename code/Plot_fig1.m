...
load('/data/users/tfang/ePC_master/data/eFC_colormap.mat')
...
load('/data/users/tfang/ePC_master/data/Net7s_alter.mat')
load('/data/users/tfang/ePC_master/data/Gray2red.mat')
...
load('/data/users/tfang/ePC_master/data/Community_color.mat')
figure, 
