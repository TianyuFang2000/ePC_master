...
G = readmatrix('/data/users/tfang/ePC_master/data/genes_matrix_csv/expression_matrix.csv');
...
load('/data/users/tfang/ePC_master/data/T_values_GLM_91edges.mat')
...
rowsmetadata = readtable('/data/users/tfang/ePC_master/data/genes_matrix_csv/rows_metadata.csv');
...
writetable(orderedtable,'/data/users/tfang/ePC_master/data/OrderedSigGenes_50kpermutations_P001.csv')
% The gene list was then subjected to Gene Ontology (GO) enrichment analysis using Metascape (https://metascape.org)
%% Plot gene list
% load gene list
Gene_list = readtable('/data/users/tfang/ePC_master/data/OrderedSigGenes_50kpermutations_P001.csv');
weight = table2array(Gene_list(:,2));
plot_gene_list(weight)
%% Plot enrichment results
Path = '/data/users/tfang/ePC_master/data';
...
load('/data/users/tfang/ePC_master/data/gene_cell_type.mat')
% get GO table
GOTable = struct;
celltypesPSP = readtable('/data/users/tfang/ePC_master/data/celltypes_PSP.csv');
...
save('/data/users/tfang/ePC_master/data/Cell_specific.mat',"GO_results",'-mat')
%% PLot cell-specific 
load('/data/users/tfang/ePC_master/data/Cell_specific.mat');
Cell_category = [];
Cell_genes = [];
Cell_p_val = [];
for i =1:7
...
GO_table = readtable('/data/users/tfang/ePC_master/data/Enrichment_results_developing/Enrichment_GO/_FINAL_GO.csv');
Enrichment_table = readtable('/data/users/tfang/ePC_master/data/Enrichment_results_developing/metascape_result.xlsx','Sheet','Enrichment');
